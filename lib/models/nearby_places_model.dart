...
// Color gradientColor = LinearGradient(colors: [Colors.blue, Colors.red]);

List<NearbyPlaceModel> nearbyPlaces = [
  NearbyPlaceModel(
    image: "assets/places/hyatt-regency-alger-aeroport.jpg",
    bgColor: const Color.fromARGB(255, 255, 222, 131),
    title: 'Hyatt Regency',
    subTitle: 'Algiers',
    price: 'Free',
    rating: 3.8,
    category: 'Hotels',
    description:
        '''A contemporary and vibrant gateway connected to Algiers Airport. Nestled in a strategic location in the dazzling city of Algiers, Hyatt Regency Algiers Airport offers the latest facilities for a connected stay in a vibrant environment. Our guestrooms feature all the comfort for a memorable stay. Palmette venues will capture your senses through enticing and authentic culinary offerings.''',
  ),
  ...
  NearbyPlaceModel(
    ...
    bgColor: const Color.fromARGB(255, 102, 142, 160),
  ...
  NearbyPlaceModel(
      ...
      bgColor: const Color.fromARGB(255, 206, 191, 149),
  ...
  NearbyPlaceModel(
    ...
    bgColor: const Color.fromARGB(255, 239, 148, 91),
  ...
  NearbyPlaceModel(
    ...
    bgColor: const Color.fromARGB(255, 86, 175, 219),
